...
class Series(IndexOpsMixin[S1], NDFrame):
    ...
    @overload
    def __add__(
        self: Series[int] | Series[float] | Series[complex],
        other: complex | Series[complex],
    ) -> Series[complex]: ...
    @overload
    def __add__(
        self,
    ...
    @overload
    def __pow__(  # pyright: ignore[reportOverlappingOverload]
        self: Series[int], other: int | _ListLike[int] | Series[int]
    ) -> Series[int]: ...
    @overload
    def __pow__(
        self: Series[int], other: float | complex | _ListLike | Series[S1]
    ) -> Series[float]: ...
    @overload
    ...
    def __rdiv__(self, other: num | _ListLike | Series[S1]) -> Series[float]: ...
    ...
    def __sub__(
        ...
        other: int | float | Series[int] | Series[float],
    ) -> Series[int]: ...
    @overload
    def __sub__(
        self: Series[int] | Series[float] | Series[complex],
    ...
    @overload
    def __truediv__(
        self: Series[int], other: num | _ListLike | Series[S1]
    ) -> Series[float]: ...
    @overload
    def __truediv__(
